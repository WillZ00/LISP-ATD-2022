...
class atdDataset(Dataset):
    ...
    def __read_data__(self):
        ...
        print("check shapes", self.data_x.shape, self.data_y.shape, self.data_stamp.shape)

        print("check types", type(self.data_x), type(self.data_y), type(self.data_stamp))
...
class atdDataset_all():
    ...
    def __read_data__(self):
        ...
        cols_data=df_raw.columns[1:5201]
