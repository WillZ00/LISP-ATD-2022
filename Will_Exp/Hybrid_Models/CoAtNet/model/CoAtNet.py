...
sys.path.append('.')
from CoAtNet.model.conv.MBConv import MBConvBlock
from CoAtNet.model.attention.SelfAttention import ScaledDotProductAttention
...
class CoAtNet(nn.Module):
    def __init__(self,in_ch,image_size,out_chs=[64,96,192,384,768]):
        ...
        self.s0=nn.Sequential(
            nn.Conv2d(in_ch,in_ch,kernel_size=5,padding=2),
            nn.ReLU(),
